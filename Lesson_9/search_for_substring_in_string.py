# Поиск подстроки в строке здесь реализован с помощью алгоритма Михаэля Рабина и Ричарда Карпа (1987)
import hashlib

def Rebin_Karp(s: str, subs: str) -> int:
