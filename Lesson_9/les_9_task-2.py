...
code = get_code(tree)
print(f'Символы в коде Хаффмана: {code}')

coding_str = coding(my_string, code)
print('Закодированная строка: ', coding_str)

decoding_str = decoding(coding_str, code)

if my_string == decoding_str:
    print('Результат кодирования - Положительный')
else:
    print('Результат кодирования - Ошибка кодирования')
